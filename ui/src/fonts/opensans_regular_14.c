...
#ifndef OPENSANS_REGULAR_14
#define OPENSANS_REGULAR_14 1
#endif

#if OPENSANS_REGULAR_14
...
#if LV_VERSION_CHECK(8, 0, 0)
const lv_font_t opensans_regular_14 = {
#else
lv_font_t opensans_regular_14 = {
#endif
