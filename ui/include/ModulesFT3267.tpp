...
#include <Arduino.h>
#endif
#include "FT5x06Constants.h"
#include "TouchLibCommon.tpp"
#include "TouchLibInterface.hpp"

class TouchLibFT3267 : public TouchLibCommon<TouchLibFT3267>,
                       public TouchLibInterface,
                       public TouchLibGesture {
...
public:
#if defined(ARDUINO)
  TouchLibFT3267(TwoWire &w, int sda = SDA, int scl = SCL, uint8_t addr = FT3267_SLAVE_ADDRESS,
                 int rst = -1) {
    __wire = &w;
    __sda = sda;
    __scl = scl;
